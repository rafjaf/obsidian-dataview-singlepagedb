...
A custom Dataview script that allows you to edit frontmatter data from a single markdown file in a convenient table interface.
...
- By default, the view is refreshed each time the table is edited. You can change this behaviour by disabling "Automatic view refreshing" in Dataview settings
